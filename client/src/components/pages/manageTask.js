...
import cerrar_icon from "../../icons/cerrar_icon.svg";
import subir_icon from "../../icons/subir_icon.svg";
        ...
        globalItems.forEach((element) => {
          if (element.series.length > 1) {
            ...
            if (element.series.length == 1) {
              ...
              let MaterialInput = {
                MaterialInputUUID: element.idOut,
                ProductID: element.product,
                /*ActualQuantity: {
                  $attributes: { unitCode: element.unit },
                  $value: element.quantity,
  ...
  return (
    <div className="flex-col fwv flex-center">
      <div className="flex-row flex-between slot fwv flex-center">
        ...
        <div className="container_button2 flex-col flex-center">
          <div className="button2 black  flex-col flex-center">
            <Link
              to="/main"
              className=""
            >
              <img alt="boton de cerrar" className="btn_close" src={cerrar_icon}/>
            </Link>
          </div>
          <div className="button2-link">
          <a onClick={saveTask} className="flex-col flex-center">
          <img alt="boton de cargar o subir información" className="btn_load" src={subir_icon}/>
          </a>            
          </div>
        </div>{" "}
      </div>
